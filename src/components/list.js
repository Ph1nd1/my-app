const charities = [
  ...
  },
  {
    ...
    summary: 'With more then 65 years since its started Save the children strives to create better futures for all children regardless of background with main arears of focuse being Education child Protectio, health and nutrition childrens Rights ',
